...
import thercn.terminal.TermPreferences;
...
public class WindowList extends ListActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (AndroidCompat.SDK >= 11) {
            ...
            if (bar != null) {
                bar.setDisplayOptions(TermPreferences.DISPLAY_HOME_AS_UP, TermPreferences.DISPLAY_HOME_AS_UP);
            }
        }
    }
