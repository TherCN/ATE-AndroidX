...
import thercn.terminal.Compat.ActivityCompat;
...
public class TerminalActivity extends AppCompatActivity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener {
    /**
    ...
    public static final String EXTRA_WINDOW_ID = "thercn.terminal.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "thercn.terminal.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "thercn.terminal.broadcast.PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "thercn.terminal.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "thercn.terminal.permission.PREPEND_TO_PATH";
    ...
    private class WindowListActionBarAdapter extends WindowListAdapter implements UpdateCallback {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView label = new TextView(TerminalActivity.this);
            String title = getSessionTitle(position, getString(R.string.window_title, position + 1));
            label.setText(title);
			label.setTextAppearance(TerminalActivity.this, TextAppearance_Holo_Widget_ActionBar_Title);
            return label;
        }
        ...
        public void onUpdate() {
			...
			//if (mActionBar != null) mActionBar.setSelectedNavigationItem(mViewFlipper.getDisplayedChild());
        }
    }
	...
	private void InitTerminal() {
				...
				public boolean onNavigationItemSelected(MenuItem menuItem) {
					switch (menuItem.getItemId()) {
						...
						case R.id.filemanager:
							startActivity(new Intent(TerminalActivity.this, FileManagerActivity.class));
							break;
							// 添加更多处理逻辑
					}
        ...
        if (actionBar != null) {
            ...
            actionBar.setNavigationMode(TermPreferences.NAVIGATION_MODE_LIST);
            actionBar.setDisplayOptions(0, TermPreferences.DISPLAY_SHOW_TITLE);
        ...
        updatePrefs();
		ControlKey controlKey = new ControlKey(this);
		controlKey.initControlKeys();
    ...
    private void populateWindowList() {
        if (mTermSessions != null) {
            ...
            if (mWinListAdapter == null) {
                ...
                if (mActionBar != null) mActionBar.setListNavigationCallbacks(mWinListAdapter, mWinListItemSelected);
            } else {
        ...
        switch (id) {
			...
			case R.id.action_help:
				Intent openHelp = new Intent(Intent.ACTION_VIEW,
											 Uri.parse("https://b23.tv/xrp63hN"));
