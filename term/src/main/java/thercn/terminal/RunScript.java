...
public final class RunScript extends RemoteInterface {
    private static final String ACTION_RUN_SCRIPT = "thercn.terminal.RUN_SCRIPT";

    private static final String EXTRA_WINDOW_HANDLE = "thercn.terminal.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "thercn.terminal.iInitialCommand";
