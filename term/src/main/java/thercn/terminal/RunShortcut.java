...
public final class RunShortcut extends RemoteInterface {
    ...
    public static final String EXTRA_WINDOW_HANDLE = "thercn.terminal.window_handle";
    public static final String EXTRA_SHORTCUT_COMMAND = "thercn.terminal.iShortcutCommand";
