...
public class RemoteInterface extends Activity {
    protected static final String PRIVACT_OPEN_NEW_WINDOW = "thercn.terminal.private.OPEN_NEW_WINDOW";
    protected static final String PRIVACT_SWITCH_WINDOW = "thercn.terminal.private.SWITCH_WINDOW";

    protected static final String PRIVEXTRA_TARGET_WINDOW = "thercn.terminal.private.target_window";

    protected static final String PRIVACT_ACTIVITY_ALIAS = "thercn.terminal.TermInternal";
